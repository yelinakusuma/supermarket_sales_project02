...
6. GX.ipynb - Notebook ini berisi proses validasi data cleaning menggunakan Great Expectations
7. images - Folder ini berisi hasil exploratory data analysis yang telah dilakukan melalui Kibana
